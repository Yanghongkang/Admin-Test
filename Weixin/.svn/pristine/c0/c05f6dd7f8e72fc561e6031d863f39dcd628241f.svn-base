...
public class DateUtil {
	...
	/**
	 * Return 缺省的日期格式 (yyyyMMdd)
	 * 
	 * @return 在页面中显示的日期格式
	 */
	public static String getDATEPATTERN_YYYYMMdd() {
		return DATEPATTERN_YYYYMMdd;
	}
	...
	public static ArrayList<String> getBetweenDays(String dateFirst, String dateSecond) {
		...
		Date dateTwo = null;
		try {
			dateOne = dateFormat.parse(dateFirst);
			dateTwo = dateFormat.parse(dateSecond);
		} catch (ParseException e) {
			e.printStackTrace();
		}
	 ...
	 * @return
	 */
	public static String getFirstDayOfMonth(int month, Date date, String pattern) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(Calendar.MONTH, month);
	 ...
	 * @return
	 */
	public static String getLastDayOfMonth(int month, Date date, String pattern) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(Calendar.MONTH, month);
	 ...
	 * @return
	 */
	public static String getMonthStr(Date date, int month, String pattern) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(Calendar.MONTH, month);
		SimpleDateFormat format = new SimpleDateFormat(pattern);
		String resultMonth = format.format(cal.getTime());
		return resultMonth;
	}
	 ...
	 * @return
	 */
	public static String getStringDate(int field, int amount, String format) {
		Calendar cal = Calendar.getInstance();
	 ...
	 * @param date
	 *            日期
	 * @return 是当前月的第一天则为true,否则为false
	 */
	public static boolean isFirstDayOfCurrentMonth() {
		String firstDay = DateUtil.getFirstDateStr(0, new Date());
		String currentDate = DateUtil.getDateStr(new Date());
		if (currentDate.equals(firstDay)) {
			return true;
		} else {
			return false;
		}
	...
	public static String getBeforeYearAndMonth(Date date, int beforeYear, int beforeMonth, String pattern) {
		Calendar cal = Calendar.getInstance();
