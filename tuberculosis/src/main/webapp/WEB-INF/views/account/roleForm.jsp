...
<body>
	<h1>角色管理</h1>
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/account/role/update" method="post" class="form-horizontal">
		...
		<fieldset>
			...
			<div class="control-group">
				<label for="groupList" class="control-label">权限:</label>
				<div class="controls">
                    <form:bscheckboxes path="authList" items="${allAuths}" itemLabel="name" itemValue="permission" />
				</div>
			</div>
